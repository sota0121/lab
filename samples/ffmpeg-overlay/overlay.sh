...
# simply concat from chunklist
ffmpeg -f concat -i ./data/chunklist.txt -c copy ./data/output-con.mp4 -y

# from chunklist - failed
# ffmpeg -f concat -i ./data/chunklist.txt -i ./data/yt_logo_rgb_light.png \
# -filter_complex "[0:v][1:v] overlay=100:25:enable='between(t,1,10)'" \
# -pix_fmt yuv420p -c:a copy \
# ./data/output-con.mp4 -y
